...
var FxKeyboardLocale = '{'+
    ...
    '"main": [['+
            ...
            '["-", "_"],'+
            '["=", "+"],'+
            '[{"label": "Backspace", "special": 8, "flex": 10, "type": "repeat"}],'+ // backspace
            '[{"label": "❌","special": "closeFX"}]'+
        '], ['+
        ...
        "], ["+
            ...
            '[";", ":"],'+
            '["\'", "\\""],'+
            '[{"label": "Clear", "flex": 15, "special": 88}]'+
        '], ['+
...
FxKeyNumpad = JSON.stringify({
    ...
    "main": [
        [
            ...
            ["0"], [{"label": "Backspace", "special": 8, "flex": 1, "type": "repeat"}]
        ], [
            [{"label": "❌","special": "closeFX","flex": 1}]
        ]
    ]
});
...
var fxKeyboard = {
    ...
    _setSpecialFunctions: function(keyD,obj) {
        ...
        else if (obj.label === "Clear") {
            keyD.onmouseup = function () {
                if (fxKeyboard.focusElement) {
                    fxKeyboard.focusElement.value = "";
                    // Trigger change/input events so other scripts react properly
